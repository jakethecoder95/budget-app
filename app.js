...
var UIController = (function() {
  ...
  var catagoriesHTML = {
    misc:
      '<div class="row misc-div"><div class="icon-div"><i class="fa        fa-question-circle"></i></div><div class="content-div"><div class="title">Misc & Checks</div><div class="description">You spent a total of <b class="misc-exp">%amt%</b> on Misc & Checks</div></div></div>',

    home:
      '<div class="row home-div"><div class="icon-div"><i class="fa fa-wrench"></i></div><div class="content-div"><div class="title">Home & Utilities</div><div class="description">You spent a total of <b class="home-exp">%amt%</b> on Home goods</div></div></div>',

    transport:
      '<div class="row transport-div"><div class="icon-div"><i class="fa fa-car"></i></div><div class="content-div"><div class="title">Transportation</div><div class="description">You spent a total of <b class="transport-exp">%amt%</b> on Transportation</div></div></div>',

    groceries:
      '<div class="row groceries-div"><div class="icon-div"><i class="fa fa-shopping-basket"></i></div><div class="content-div"><div class="title">Groceries</div><div class="description">You spent a total of <b class="groceries-exp">%amt%</b> on Groceries</div></div></div>',

    insurance:
      '<div class="row insurance-div"><div class="icon-div"><i class="fa fa-piggy-bank"></i></div><div class="content-div"><div class="title">Insurance</div><div class="description">You spent a total of <b class="insurance-exp">%amt%</b> on Insurance</div></div></div>',

    dining:
      '<div class="row dining-div"><div class="icon-div"><i class="fa fa-utensils"></i></div><div class="content-div"><div class="title">Restaurants and Dining</div><div class="description">You spent a total of <b class="dining-exp">%amt%</b> on Restaurants and Dining</div></div></div>',

    entertainment:
      '<div class="row entertainment-div"><div class="icon-div"><i class="fa fa-theater-masks"></i></div><div class="content-div"><div class="title">Entertainment</div><div class="description">You spent a total of <b class="entertainment-exp">%amt%</b> on Entertainment</div></div></div>'
  };
  ...
  return {
    ...
    displayBudget: function(obj) {
      ...
      document.querySelector(
        DOMstrings.outputBudget
      ).textContent = formatNumber(obj.budget, type);
      document.querySelector(DOMstrings.outputInc).textContent = formatNumber(
        obj.totalInc,
        "inc"
      );
      document.querySelector(DOMstrings.outputExp).textContent = formatNumber(
        obj.totalExp,
        "exp"
      );
    ...
    displayCatagoriesList: function(sums) {
      ...
      document.querySelector(DOMstrings.overviewContainer).style.height =
        "600px";
      ...
      sums.forEach(function(cur) {
        ...
        if (cur[1] > 0) {
          document
            .querySelector(DOMstrings.overviewContainer)
            .insertAdjacentHTML("beforeend", catagoriesHTML[current]);
          document.querySelector("." + current + "-exp").innerHTML = cur[1];

          if (count > 3) {
            document.querySelector(
              DOMstrings.overviewContainer
      ...
      if (plusBTN === null && count > 4) {
        document
          .querySelector(DOMstrings.overviewContainer)
          .insertAdjacentHTML("beforeend", plusHTML);
    ...
    showOverflowItems: function() {
      ...
      document
        .querySelector(DOMstrings.overviewContainer)
        .insertAdjacentHTML("beforeend", minusHTML);

      // Show overflow items
      containerList = document.querySelector(DOMstrings.overviewContainer)
        .children;
    ...
    hideOverflowItems: function() {
      ...
      if (loops > 0) {
        for (loops; loops > 0; loops--) {
          containerList[containerList.length - 1 - loops].style.display =
            "none";
          containerList[containerList.length - 1 - loops].classList.remove(
            "show"
          );
        }
      }
    ...
    slideToNextDiv: function() {
      ...
      overviewCls = document.querySelector(DOMstrings.overviewContainer)
        .classList;
      detailsCls = document.querySelector(DOMstrings.detailsContainer)
        .classList;
    ...
    getChartCanvas: function() {
      ...
      canvas = '<canvas class="doughnut__chart"></canvas>';
    ...
    displayCatListItems: function(cat) {
      ...
      for (var i = 0; i < listLength; i++) {
        document
          .querySelector(DOMstrings.details)
          .insertAdjacentHTML("beforeend", newItems[i].outerHTML);
      }
    },
    ...
    displayDetailDiv: function(cat) {
      ...
      header.firstChild.insertAdjacentHTML(
        "beforeend",
...
var Controller = (function(budgetCtrl, UICtrl) {
  var setupEventListenters = function() {
    ...
    document
      .querySelector(DOM.forwardBtn)
      .addEventListener("click", UICtrl.slideToNextSection);
    document
      .querySelector(DOM.backBtn)
      .addEventListener("click", UICtrl.slideToNextSection);
    ...
    document
      .querySelector(DOM.inputType)
      .addEventListener("change", UICtrl.toggleCatagoryFields);

    // Show overflow catagories on click
    document
      .querySelector(DOM.piechart)
    ...
    // Slide to next div
    document
      .querySelector(DOM.overviewContainer)
      .addEventListener("click", function(event) {
        var node, catagory;
  ...
  var updateCatAmounts = function() {
    ...
    if (header.childElementCount > 0) {
      ...
      if (sum) {
        UICtrl.displayDetailsSum(sum, cat[0]);
      }
    }
  };
